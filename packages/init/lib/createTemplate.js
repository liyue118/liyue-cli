...
import { log, makeList, makeInput, getLatestVersion, request, printErrorLog } from '@liyue.com/utils';
...
export default async function createTemplate(name, opts){
  ...
  if(addType === ADD_TYPE_PROJECT){
    ...
    // 通过获取最新版本号  直接get请求 registry.npmjs.org/@liyue.com/template-vue3
    const latestVersion = await getLatestVersion(selectedTemplate.npmName)
    log.verbose(latestVersion)
